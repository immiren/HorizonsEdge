...
void AHorizonsEdgeCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AHorizonsEdgeCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AHorizonsEdgeCharacter::Move);
...
void AHorizonsEdgeCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AHorizonsEdgeCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
